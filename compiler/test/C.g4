...
//赋值语句
assignBlock 
    :   ((arrayIdentifier|Identifier|structMember) '=')+  expression ';'
    ;
...
//scanf
scanfFunction 
    :   'scanf' '(' StringLiteral (',' ('&')? (Identifier|arrayIdentifier|structMember))* ')'
    ;
//gets
getsFunction 
    :   'gets' '(' Identifier ')'
...
//结构体成员调用
structMember
    :   (Identifier | arrayIdentifier) '.' (Identifier | arrayIdentifier)
    ;
